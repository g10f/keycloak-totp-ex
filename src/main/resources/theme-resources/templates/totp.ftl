...
<table class="table table-bordered table-striped">
    ...
    <tbody>
        <#if totp.countTOTPCredentials gt 0>
        <tr>
        ...
        <#if totp.countTOTPExCredentials gt 0 >
            <tr>
                <td class="provider">${msg("mobile")} (GroupIDP)</td>
                <td class="action">
                    <a href="" class="button"><i class="pficon pficon-delete"></i></a>
                </td>
            </tr>
        </#if>
        </tbody>
